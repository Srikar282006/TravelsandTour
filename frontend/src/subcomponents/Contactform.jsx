                ...
                <div className="bg-white p-8 rounded-lg shadow-xl border border-gray-200 flex flex-col justify-between">
                    <div>
                        ...
                        <p className="text-gray-700 leading-relaxed mb-3">
                            Book your exclusive Hyderabad to Srisailam tour package today and embark on a unique journey. Explore Srisailam your way, at your own pace. For bookings and inquiries, feel free to contact us. Make unforgettable memories with Sri Sai Tours & Travels!
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center text-gray-700">
                                ...
                                <span>info@kntourstravels.com</span>
                            </div>
