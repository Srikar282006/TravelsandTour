    ...
    <footer className="footer sm:footer-horizontal bg-base-300 text-base-content p-10 py-10">
      ...
      <nav>
        ...
        <a className="link link-hover flex items-center gap-1">
          ...
          info@gagantravels.com
        </a>
      </nav>
     
    </footer>
     <div className='bg-base-300 text-base-content text-center text-sm py-4'>@gagantravels.com. All Rights Reversed.</div>
    </>
  )
}
